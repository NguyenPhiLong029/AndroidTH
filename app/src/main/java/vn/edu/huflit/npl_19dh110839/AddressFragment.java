...
import vn.edu.huflit.npl_19dh110839.locationSearvice.LocationServiceTask;
...
public class AddressFragment extends Fragment {
    TextInputEditText tvAddress, tvPhone;
    Button btnNext;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tvAddress.getText().toString().isEmpty()) {
                    tvAddress.setError("Address chua chinh xac");
                    return;
                }
                if (tvPhone.getText().toString().isEmpty()) {
                    tvPhone.setError("Phone required");
                    return;
                }
                if (tvPhone.getText().toString().length() < 10) {
                    tvPhone.setError("Phone chua chinh xac");
                    return;
                } else {
